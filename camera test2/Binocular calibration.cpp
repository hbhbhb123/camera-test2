...
int main()
{
	...
	//读取内部参数
	CvMat *Intrinsics_Camera_Left = (CvMat *)cvLoad("left_intrinsics.xml");
	CvMat *Intrinsics_Camera_Right = (CvMat *)cvLoad("right_intrinsics.xml");
	CvMat *Distortion_Camera_Left = (CvMat *)cvLoad("left_distorted.xml");
	CvMat *Distortion_Camera_Right = (CvMat *)cvLoad("right_distorted.xml");
	CvMat *Translation_matlab = (CvMat *)cvLoad("Translation.xml");
	CvMat *RotRodrigues_matlab = (CvMat *)cvLoad("Rotation.xml");
